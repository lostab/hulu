...
if 'VCAP_SERVICES' in os.environ:
    ...
    import swiftclient
    OC = swiftclient.Connection(key=ocp['password'], authurl=ocp['auth_url'], auth_version='3', os_options={'project_id': ocp['projectId'], 'user_id': ocp['userId'], 'region_name': ocp['region']})
