...
var ajaxload = function(url){
    if($("body .ajaxloading").length == 0) {
        ...
        $(".wrapper").after($("<div class=\"ajaxloading\" style=\"background:lightgray;opacity:0.8;top:0;position:fixed;z-index:999;width:100%;height:100%;margin:0;padding:0;vertical-align:middle;\"><div class=\"loading-content\" style=\"text-align:center;width:100%;height:10px;position:absolute;top:50%;margin-top:-5px;\"><!--<span style=\"\">" + (($('html').attr('lang') == "zh")?"加载中…":"loading...") + "</span>--><img src=\"/s/loading.gif\" style=\"width: 32px;height: 32px;\" /></div></div>"));
        $.ajaxSetup({
            cache: true
        });
        $.ajax({
